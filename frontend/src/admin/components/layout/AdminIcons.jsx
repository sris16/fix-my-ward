...
const SvgBase = ({ children, className = "w-5 h-5", ...props }) => (
  <svg
...
export const CitizensIcon = (props) => (
  <SvgBase {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
  </SvgBase>
);

export const LiveMonitorIcon = (props) => (
  <SvgBase {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 0L21 9m-1.5-3L15 16.5M9 15.667l10.5-3m0 0L21 15.667m-1.5-3L15 22.5M2.25 12a9.75 9.75 0 1119.5 0 9.75 9.75 0 01-19.5 0z" />
  </SvgBase>
);
...
export const MenuCollapseIcon = (props) => (
  <SvgBase {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5" />
  </SvgBase>
);

export const MenuExpandIcon = (props) => (
  <SvgBase {...props}>
